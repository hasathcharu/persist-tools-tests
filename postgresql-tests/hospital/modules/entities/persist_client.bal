...
public isolated client class Client {
    *persist:AbstractPersistClient;
    ...
    public isolated function init() returns persist:Error? {
        ...
        self.persistClients = {
            [APPOINTMENT]: check new (dbClient, self.metadata.get(APPOINTMENT), psql:POSTGRESQL_SPECIFICS),
            [PATIENT]: check new (dbClient, self.metadata.get(PATIENT), psql:POSTGRESQL_SPECIFICS),
            [DOCTOR]: check new (dbClient, self.metadata.get(DOCTOR), psql:POSTGRESQL_SPECIFICS)
        };
    }
